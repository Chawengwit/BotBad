...
- [ ] 23 คิดเงินหารค่าใช้จ่ายต่อรอบ — วางแผนไว้ใน [`docs/PRP/bill-splitting.md`](docs/PRP/bill-splitting.md)
...
| `บอทจ๋า ปิดรอบ` | ยืนยันแล้วรอบเป็น `completed` เปิดรอบใหม่ได้ (เฉพาะผู้สร้าง) |

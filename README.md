...
| ในกลุ่ม พิมพ์ `บอทจ๋า เปิดตี` | ถามคอร์ท → จำนวนคน → วัน → เวลา → ชั่วโมง → ชื่อคอร์ท → แผนที่ → การ์ดยืนยัน |
...
| `บอทจ๋า แก้ไข` | เลือกคอร์ท/จำนวนคน/วัน/เวลา/ระยะเวลา/ชื่อคอร์ท/แผนที่ → การ์ดยืนยัน (เฉพาะผู้สร้าง) |

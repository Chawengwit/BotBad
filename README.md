...
| `บอทจ๋า ถอนชื่อ` หรือกดปุ่ม ❌ | ถอนชื่อแล้วส่งการ์ดใหม่ (ลงกลับเข้ามาใหม่ได้) เปลี่ยนใจเกิน 2 ครั้งบอทจะแซว |
...
| `บอทจ๋า จ่ายแล้ว` / `ยังไม่จ่าย` หรือกดปุ่ม 💸 | บันทึกสถานะการจ่ายของตัวเอง |
...
กติกาของปุ่ม: เฉพาะคนที่สั่งเท่านั้นที่กดได้ ใช้ได้ครั้งเดียว หมดอายุใน 10 นาที และทำได้เฉพาะกับรอบที่ออกการ์ดไว้

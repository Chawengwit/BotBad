...
| ในกลุ่ม พิมพ์ `บอทจ๋า เปิดตี` | ถามคอร์ท → จำนวนคน → วัน → เวลา → ชั่วโมง → ชื่อคอร์ท → แผนที่ → พร้อมเพย์ → การ์ดยืนยัน |
...
บอทแนบปุ่มเฉพาะตอน **กำลังถาม**, **ขอให้กดยืนยัน** และ **ทักทาย/เมนูสำรอง** เท่านั้น (spec §23)

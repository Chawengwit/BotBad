...
- คำสั่งพิมพ์ไม่อ่านวันเอง แต่ `ลงชื่อ` / `ถอนชื่อ` ที่ต่อท้ายด้วยวันหรือรอบ เช่น `ลงชื่อ รอบวันเสาร์`
  ไม่ถือเป็นชื่อคน ส่งทั้งประโยคให้ Gemini อ่าน (ไม่มี Gemini ทำเหมือนคำสั่งเปล่า)
  เคยกลายเป็นแขกชื่อ "รอบวันเสาร์" (ทดสอบกับ Gemini จริง 2026-09-19) ชื่อคนอย่าง "วันชัย" ยังเป็นชื่อคน

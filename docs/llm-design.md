...
- App เห็น `IGNORE` แล้วต้อง **เงียบ** และปิดโหมดฟัง
...
### โหมดฟังไม่ปิดเพราะงานสำเร็จ

ไม่ว่า tool ไหนจะทำงานสำเร็จ โหมดฟังก็ยังเปิดต่อ ปิดเฉพาะตอนที่ LLM ตอบ `IGNORE`
หรือตีความไม่ออกในโหมดฟัง (spec §6)
